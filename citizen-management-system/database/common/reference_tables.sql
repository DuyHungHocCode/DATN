...
BEGIN
    ...
    COMMENT ON TABLE reference.region IS 'Bảng tham chiếu vùng miền';
    ...
    COMMENT ON TABLE reference.province IS 'Bảng tham chiếu tỉnh/thành phố';
    ...
    COMMENT ON TABLE reference.district IS 'Bảng tham chiếu quận/huyện';
    ...
    CREATE TABLE IF NOT EXISTS reference.ward (
        ...
        district_id INT REFERENCES reference.district(district_id),
    ...
    COMMENT ON TABLE reference.ward IS 'Bảng tham chiếu phường/xã';
    ...
    COMMENT ON TABLE reference.ethnicity IS 'Bảng tham chiếu dân tộc';
    ...
    COMMENT ON TABLE reference.religion IS 'Bảng tham chiếu tôn giáo';
    ...
    COMMENT ON TABLE reference.nationality IS 'Bảng tham chiếu quốc tịch';
    ...
    COMMENT ON TABLE reference.relationship_type IS 'Bảng tham chiếu loại quan hệ gia đình';
    ...
    COMMENT ON TABLE reference.education_level IS 'Bảng tham chiếu trình độ học vấn';
    ...
    COMMENT ON TABLE reference.occupation_type IS 'Bảng tham chiếu loại nghề nghiệp';
    ...
    COMMENT ON TABLE reference.document_type IS 'Bảng tham chiếu loại giấy tờ';
    ...
    COMMENT ON TABLE reference.record_status IS 'Bảng tham chiếu trạng thái hồ sơ';
    ...
    COMMENT ON TABLE reference.issuing_authority IS 'Bảng tham chiếu cơ quan cấp';
    ALTER TABLE reference.issuing_authority 
    ADD CONSTRAINT fk_parent_authority
    ...
    COMMENT ON TABLE reference.user_role IS 'Bảng tham chiếu vai trò người dùng';
    ...
    COMMENT ON TABLE reference.encryption_type IS 'Bảng tham chiếu các yếu tố mã hóa';
    ...
    COMMENT ON TABLE reference.access_reason IS 'Bảng tham chiếu lý do truy cập dữ liệu';
END;
$$ LANGUAGE plpgsql;
...
DROP FUNCTION create_reference_tables();
DROP FUNCTION create_reference_indexes();
